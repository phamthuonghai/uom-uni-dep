...
FEATURE_FILE=./models/en-ud-train-nolabel-ft.pkl
MODEL_PREFIX=./models/en-ud-train-nolabel
PARSE_INPUT=./data/ud-treebanks-conll2017/UD_English/en-ud-dev.conllu
PARSE_OUTPUT=./models/en-ud-res-nolabel.conllu
TEMPLATE_FILE=./config/chen-nolabel.template
